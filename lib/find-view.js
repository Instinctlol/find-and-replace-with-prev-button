...
class FindView {
        ...
        $.section({className: 'input-block find-container'},
          ...
          $.div({className: 'input-block-item'},
            $.div({className: 'btn-group btn-group-find'},
              $.button({ref: 'nextButton', className: 'btn btn-next'}, 'Find Next')
            ),
            $.div({className: 'btn-group btn-group-find'},
                $.button({ref: 'prevButton', className: 'btn btn-prev'}, 'Find Prev')
            ),
  ...
  handleEvents() {
    ...
    this.refs.prevButton.addEventListener('click', e => this.findPrevious({focusEditorAfter: true}));
